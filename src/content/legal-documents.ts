    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "서비스 이용 과정에서 워크스페이스 정보, 점수판, 선행지표, 일일 기록, 팀 메모, 프로필 설정(아바타, 언어), 알림 설정, 푸시 구독 정보(endpoint, p256dh, auth)를 처리합니다.",
      ...
      },
      {
        ...
        body: [
          ...
          "푸시 구독 정보(endpoint, p256dh, auth)는 이용자가 알림을 해제하거나 해당 구독이 만료·무효화될 때까지 보유합니다.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "During service use, we process workspace information, scoreboards, lead measures, daily logs, team memos, profile settings (avatar and locale), notification settings, and push subscription data (endpoint, p256dh, auth).",
      ...
      },
      {
        ...
        body: [
          ...
          "Push subscription data (endpoint, p256dh, auth) is retained until the user disables notifications or the subscription expires or becomes invalid.",

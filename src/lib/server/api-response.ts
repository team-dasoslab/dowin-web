...
export type ErrorCode =
  ...
  | "TEAM_CHECKIN_DISABLED"
  | "TEAM_CHECKIN_NOT_FOUND"
  | "TEAM_CHECKIN_ALREADY_RESPONDED"
  | "TEAM_CHECKIN_RESPONSE_REQUIRED"
  | "TEAM_CHECKIN_RESPONSE_NOT_ACTIONABLE"
  | "TEAM_CHECKIN_PROPOSAL_NOT_FOUND"
  | "TEAM_CHECKIN_PROPOSAL_ALREADY_OPEN"
  | "TEAM_CHECKIN_PROPOSAL_NOT_OPEN"
  | "TEAM_CHECKIN_PROPOSAL_EXPIRED"
  | "TEAM_CHECKIN_PROPOSAL_APPLY_FAILED";
...
const ERROR_STATUS: Partial<Record<ErrorCode, number>> = {
  ...
  WORKSPACE_ACTIVE_SUBSCRIPTION_DELETE_FORBIDDEN: 409,
  ...
  TEAM_CHECKIN_DISABLED: 403,
  TEAM_CHECKIN_NOT_FOUND: 404,
  TEAM_CHECKIN_ALREADY_RESPONDED: 409,
  TEAM_CHECKIN_RESPONSE_REQUIRED: 400,
  TEAM_CHECKIN_RESPONSE_NOT_ACTIONABLE: 409,
  TEAM_CHECKIN_PROPOSAL_NOT_FOUND: 404,
  TEAM_CHECKIN_PROPOSAL_ALREADY_OPEN: 409,
  TEAM_CHECKIN_PROPOSAL_NOT_OPEN: 409,
  TEAM_CHECKIN_PROPOSAL_EXPIRED: 409,
  TEAM_CHECKIN_PROPOSAL_APPLY_FAILED: 409,

...
import { PersonDelete20Regular, ShieldLock20Regular } from "@fluentui/react-icons";
    ...
    >
      ...
      <div className="flex items-center gap-2">
        {canTransferAdmin ? (
          ...
          >
            <ShieldLock20Regular className="h-3.5 w-3.5" />
        ...
        >
          <PersonDelete20Regular className="h-3.5 w-3.5" />

...
import { Inbox, ChevronLeft, X } from "lucide-react";
import { useParams } from "next/navigation";
import { useTeamMemberCheckInActions, CheckInStatus } from "@/app/[locale]/(protected)/[workspaceId]/dashboard/_hooks/useTeamMemberCheckInActions";
import {
...
export function TeamMemberCheckIn() {
  ...
  const {
    ...
    acceptProposal,
    declineProposal,
  } = useTeamMemberCheckInActions(workspaceId);

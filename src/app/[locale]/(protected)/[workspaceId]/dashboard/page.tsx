...
export default function DashboardPage() {
  ...
  const myMember = useMemo(
    () =>
      membersWithScoreboard.find((member) => member.userId === myUserId) ??
      null,
    [membersWithScoreboard, myUserId],
  );

  const { exportRef, isExporting, isShareSupported, saveImage } =
    useScoreboardImageExport({
      member: myMember,

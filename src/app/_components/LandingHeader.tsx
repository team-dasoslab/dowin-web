...
export function LandingHeader() {
  ...
  return (
    <header className="fixed top-0 z-50 h-16 w-full bg-surface/80 backdrop-blur-xl">
      <div className="mx-auto flex h-full max-w-[1200px] items-center justify-between px-6 md:px-12">
        <Link href="/" className="flex items-center gap-2.5">
          <Logo />
          <p className="text-[22px] font-black tracking-tight text-text-primary uppercase">
            {tCommon("serviceName")}
          </p>
        </Link>

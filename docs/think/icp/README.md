...
이 폴더는 경로 이름만 `consulting`으로 남아 있는 레거시 폴더다.  
현재 기준으로는 `Dowin ICP 탐색`에 직접 필요한 메모만 남겨 둔 상태다.

핵심 목적은 아래 세 가지다.

1. 어떤 고객 구조가 Dowin와 맞는지 좁힌다
2. 세그먼트별 문제 문장을 다듬는다
3. 기존 리서치를 `확정 결론`이 아니라 `가설 자산`으로 관리한다

즉 지금 이 폴더는 `컨설팅 사업 문서함`이 아니라  
`Dowin ICP 탐색용 보조 노트 폴더`로 읽는 편이 맞다.

## 권장 읽기 순서

### 1. [30-2026-05-13-dowin-icp-research-audit.md](./30-2026-05-13-dowin-icp-research-audit.md)

- 기존 컨설팅 리서치를 지금 어떤 기준으로 읽어야 하는지 정리한 감사 메모
- 무엇을 믿고 무엇을 경계해야 하는지 먼저 고정한다

### 2. [29-2026-05-09-customer-research-reset-around-structure-not-industry.md](./29-2026-05-09-customer-research-reset-around-structure-not-industry.md)

- 업종보다 운영 구조를 먼저 봐야 한다는 리서치 리셋 문서
- 다음 인터뷰와 세그먼트 판단의 기준점으로 쓴다

### 3. [19-2026-05-09-dowin-customer-segmentation-reset.md](./19-2026-05-09-dowin-customer-segmentation-reset.md)
...
- founder-led 소규모 팀에 대한 온라인 pain language 관찰 로그
- 실제 인터뷰 전 문제 문장과 질문 후보를 다듬을 때 쓴다

### 7. [32-2026-05-13-founder-led-team-icp-six-pager.md](./32-2026-05-13-founder-led-team-icp-six-pager.md)
...
지금 이 폴더를 통해 답하려는 질문은 하나다.

`Dowin는 누구의 어떤 운영 문제를 줄여주는 도구인가`

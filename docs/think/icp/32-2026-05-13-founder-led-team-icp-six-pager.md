...
이 문서는 그중에서도 `대표가 직접 운영을 chase하는 founder-led 소규모 팀`을 Dowin의 유력 ICP 후보로 보고, 온라인 공개 자료를 통해 어떤 pain가 반복되는지 정리한 6-pager다.
...
현재 시점의 가장 강한 가설을 정리한 `의사결정 지원 문서`다.

## 2. 고객 가설

현재 가장 유력한 ICP 후보는 아래에 가깝다.
